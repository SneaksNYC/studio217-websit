      ...
      <style jsx global>{`
        *, *::before, *::after { margin: 0; padding: 0; box-sizing: border-box; }
        ...
        .nav-cta {
          ...
          background-size: 200% 200% !important; color: var(--white) !important;
          padding: 10px 24px !important; border-radius: 8px;
          font-weight: 600 !important; transition: all 0.35s cubic-bezier(.25,.8,.25,1) !important;
        ...
        .nav-cta:hover { transform: translateY(-2px) scale(1.03); box-shadow: 0 8px 30px var(--accent-glow); }
        ...
        .service-card::before {
          ...
          background: linear-gradient(135deg, var(--accent-glow) 0%, var(--green-glow) 100%);
          opacity: 0;
      ...
      <nav>
        <div className="container">
          ...
          <div className="nav-links">
            ...
            <a href="#contact" className="nav-cta">Get Early Access</a>
          </div>
        </div>
      </nav>
